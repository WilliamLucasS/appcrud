...
// Verifica se hÃ¡ algum erro armazenado na sessÃ£o
if (isset($_SESSION['erro_compra'])) {
    $erro = $_SESSION['erro_compra'];
    unset($_SESSION['erro_compra']);  // Limpa o erro apÃ³s exibiÃ§Ã£o
} else {
    // Se nÃ£o houver erro, redireciona para a pÃ¡gina inicial
